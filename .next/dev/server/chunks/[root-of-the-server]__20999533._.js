...
function getCredential() {
    ...
    // 2. Archivo de service account en la raíz del proyecto
    const defaultPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "lait-video-editor-firebase-adminsdk-fbsvc-feeabf3dcd.json");
    try {
        return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$app__$5b$external$5d$__$28$firebase$2d$admin$2f$app$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$29$__["cert"])(defaultPath);
    } catch  {
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
async function POST(request) {
    ...
    try {
        const decoded = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminAuth"].verifyIdToken(idToken);
        const sessionToken = await new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$sign$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SignJWT"]({
            uid: decoded.uid,
            ...
            alg: "HS256"
        }).setIssuedAt().setExpirationTime(`${SESSION_DURATION}s`).sign(SESSION_SECRET);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__20999533._.js.map