...
function loadServiceAccountFromFile(filePath) {
    try {
        const resolved = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(process.cwd(), filePath);
        const raw = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(resolved, "utf-8");
        const serviceAccount = JSON.parse(raw);
        if (serviceAccount?.private_key) return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$app__$5b$external$5d$__$28$firebase$2d$admin$2f$app$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$29$__["cert"])(serviceAccount);
    } catch  {
...
function getCredential() {
    // 1. Usar archivo JSON si GOOGLE_APPLICATION_CREDENTIALS está definido
    const adcPath = process.env.GOOGLE_APPLICATION_CREDENTIALS;
    if (adcPath) {
        const cred = loadServiceAccountFromFile(adcPath);
        if (cred) return cred;
    }
    // 2. Usar archivo de service account por ruta explícita o por defecto
    const saPath = process.env.FIREBASE_SERVICE_ACCOUNT_PATH ?? "lait-video-editor-firebase-adminsdk-fbsvc-feeabf3dcd.json";
    const cred = loadServiceAccountFromFile(saPath);
    if (cred) return cred;
    // 3. Usar variables de entorno
    const raw = process.env.FIREBASE_PRIVATE_KEY;
    if (!raw) throw new Error("Configura credenciales: GOOGLE_APPLICATION_CREDENTIALS, FIREBASE_SERVICE_ACCOUNT_PATH, o FIREBASE_PRIVATE_KEY en .env");
    const key = raw.replace(/\\n/g, "\n").trim();
    if (!key.includes("BEGIN PRIVATE KEY")) {
        throw new Error("FIREBASE_PRIVATE_KEY tiene formato incorrecto. Usa GOOGLE_APPLICATION_CREDENTIALS apuntando al JSON del service account para evitar problemas de escape.");
    }
...
const adminApp = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$app__$5b$external$5d$__$28$firebase$2d$admin$2f$app$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$29$__["getApps"])().length === 0 ? (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$app__$5b$external$5d$__$28$firebase$2d$admin$2f$app$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$29$__["initializeApp"])({
    ...
    projectId: process.env.FIREBASE_PROJECT_ID ?? "lait-video-editor",
    storageBucket: process.env.FIREBASE_STORAGE_BUCKET ?? "lait-video-editor.firebasestorage.app"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2cb48d9d._.js.map