...
"[project]/node_modules/@remotion/media/dist/esm/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// src/audio/audio.tsx
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@remotion/media/node_modules/remotion/dist/esm/index.mjs [app-client] (ecmascript)");
...
var __using = (stack, value, async)=>{
    if (value != null) {
        ...
        if (dispose === undefined) dispose = value[__dispose];
...
;
;
var getTimeInSeconds = ({ loop, mediaDurationInSeconds, unloopedTimeInSeconds, src, trimAfter, trimBefore, fps, playbackRate, ifNoMediaDuration })=>{
    ...
    const loopDuration = loop ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].calculateMediaDuration({
        trimAfter,
...
var calculateEndTime = ({ mediaDurationInSeconds, ifNoMediaDuration, src, trimAfter, trimBefore, fps })=>{
    if (mediaDurationInSeconds === null && ifNoMediaDuration === "fail") {
        throw new Error(`Could not determine duration of ${src}, but "loop" was set.`);
    }
    const mediaDuration = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].calculateMediaDuration({
        trimAfter,
        mediaDurationInFrames: mediaDurationInSeconds ? mediaDurationInSeconds * fps : Infinity,
        playbackRate: 1,
        trimBefore
...
var setGlobalTimeAnchor = ({ audioContext, audioSyncAnchor, absoluteTimeInSeconds, globalPlaybackRate, debugAudioScheduling, logLevel })=>{
    ...
    if (debugAudioScheduling) {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.info({
            logLevel,
            tag: "audio-scheduling"
        }, "Anchor changed from %s to %s with shift %s", audioSyncAnchor.value, newAnchor, shift);
    }
...
var makeAudioIterator = (startFromSecond, maximumTimestamp, cache, debugAudioScheduling)=>{
    ...
    const moveQueuedChunksToPauseQueue = ()=>{
        ...
        if (debugAudioScheduling && toQueue.length > 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.trace({
                logLevel: "trace",
                tag: "audio-scheduling"
...
var makeIteratorWithPriming = ({ audioSink, timeToSeek, maximumTimestamp })=>{
...
var makePrewarmedAudioIteratorCache = (audioSink)=>{
    ...
    const prewarmIteratorForLooping = ({ timeToSeek, maximumTimestamp })=>{
        if (!prewarmedAudioIterators.has(makeKey(timeToSeek, maximumTimestamp))) {
            prewarmedAudioIterators.set(makeKey(timeToSeek, maximumTimestamp), makeIteratorWithPriming({
                audioSink,
                timeToSeek,
                maximumTimestamp
            }));
...
var audioIteratorManager = ({ audioTrack, delayPlaybackHandleIfNotPremounting, sharedAudioContext, getIsLooping, getEndTime, getStartTime, initialMuted, drawDebugOverlay })=>{
    let muted = initialMuted;
    let currentVolume = 1;
    const gainNode = sharedAudioContext.createGain();
    gainNode.connect(sharedAudioContext.destination);
    const audioSink = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$media$2d$sink$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioBufferSink"](audioTrack);
    ...
    const scheduleAudioChunk = ({ buffer, mediaTimestamp, playbackRate, scheduleAudioNode, debugAudioScheduling })=>{
        ...
        if (started.type === "not-started") {
            if (debugAudioScheduling) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.info({
                    logLevel: "trace",
                    tag: "audio-scheduling"
                }, "not started, disconnected: %s %s", mediaTimestamp.toFixed(3), buffer.duration.toFixed(3));
            }
            node.disconnect();
            return;
        }
    ...
    const resumeScheduledAudioChunks = ({ playbackRate, scheduleAudioNode, debugAudioScheduling })=>{
        if (muted) {
            return;
        }
        if (!audioBufferIterator) {
    ...
    const onAudioChunk = ({ getIsPlaying, buffer, playbackRate, scheduleAudioNode, debugAudioScheduling })=>{
        if (muted) {
            return;
        }
        ...
        if (getIsPlaying() && sharedAudioContext.state === "running" && (sharedAudioContext.getOutputTimestamp().contextTime ?? 0) > 0) {
            ...
            if (debugAudioScheduling) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.info({
                    logLevel: "trace",
                    tag: "audio-scheduling"
                }, "not ready, added to queue: %s %s", buffer.timestamp.toFixed(3), buffer.duration.toFixed(3));
            }
            audioBufferIterator.addChunkForAfterResuming(buffer.buffer, buffer.timestamp);
        }
        drawDebugOverlay();
    };
    const startAudioIterator = async ({ nonce, playbackRate, startFromSecond, getIsPlaying, scheduleAudioNode, debugAudioScheduling })=>{
        let __stack = [];
        try {
            if (muted) {
                return;
            ...
            try {
                ...
                if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$input$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InputDisposedError"]) {
                    return;
                }
                throw e;
            }
    ...
    const seek = async ({ newTime, nonce, playbackRate, getIsPlaying, scheduleAudioNode, debugAudioScheduling })=>{
        if (muted) {
            return;
        }
        if (getIsLooping()) {
...
var drawPreviewOverlay = ({ context, audioTime, audioContextState, audioSyncAnchor, playing, audioIteratorManager: audioIteratorManager2, videoIteratorManager, playbackRate })=>{
...
var videoIteratorManager = ({ delayPlaybackHandleIfNotPremounting, canvas, context, drawDebugOverlay, logLevel, getOnVideoFrameCallback, videoTrack, getEndTime, getStartTime, getIsLooping })=>{
    ...
    const canvasSink = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$media$2d$sink$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CanvasSink"](videoTrack, {
        poolSize: 2,
        fit: "contain",
        alpha: true
    });
...
class MediaPlayer {
    ...
    constructor({ canvas, src, logLevel, sharedAudioContext, loop, trimBefore, trimAfter, playbackRate, globalPlaybackRate, audioStreamIndex, fps, debugOverlay, debugAudioScheduling, bufferState, isPremounting, isPostmounting, durationInFrames, onVideoFrameCallback, playing, sequenceOffset }){
        ...
        this.input = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$input$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"]({
            source: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$source$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UrlSource"](this.src),
            formats: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$input$2d$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ALL_FORMATS"]
        });
        if (canvas) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.error({
                        logLevel: this.logLevel,
                        tag: "@remotion/media"
                    }, `[MediaPlayer] Failed to recognize format for ${this.src}`, error);
                    return {
                ...
                try {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.error({
                        logLevel: this.logLevel,
                        tag: "@remotion/media"
                    }, "[MediaPlayer] Failed to start audio and video iterators", error);
                }
                return {
                    type: "success",
                    durationInSeconds
                ...
                if (isNetworkError(err)) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.error({
                        logLevel: this.logLevel,
                        tag: "@remotion/media"
                    }, `[MediaPlayer] Network/CORS error for ${this.src}`, err);
                    return {
                        type: "network-error"
                    };
                }
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.error({
                    logLevel: this.logLevel,
                    tag: "@remotion/media"
                }, "[MediaPlayer] Failed to initialize", error);
                throw error;
            }
        } catch (_catch) {
            var _err = _catch, _hasErr = 1;
...
// src/on-error.ts
var callOnErrorAndResolve = ({ onError, error, disallowFallback, isClientSideRendering, clientSideError })=>{
...
;
;
var useLoopDisplay = ({ loop, mediaDurationInSeconds, playbackRate, trimAfter, trimBefore })=>{
    const { durationInFrames: compDuration, fps } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useVideoConfig"])();
    const loopDisplay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useLoopDisplay.useMemo[loopDisplay]": ()=>{
            if (!loop || !mediaDurationInSeconds) {
                return;
            }
            const durationInFrames = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].calculateMediaDuration({
...
;
;
var useCommonEffects = ({ mediaPlayerRef, mediaPlayerReady, currentTimeRef, playing, isPlayerBuffering, frame, trimBefore, trimAfter, effectiveMuted, userPreferredVolume, playbackRate, globalPlaybackRate, fps, sequenceOffset, loop, debugAudioScheduling, durationInFrames, isPremounting, isPostmounting, currentTime, logLevel, sharedAudioContext, label })=>{
    const absoluteTime = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useAbsoluteTimelinePosition();
    const { playing: playingWhilePremounting } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].PremountContext);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "useCommonEffects.useLayoutEffect": ()=>{
...
;
;
var useMediaInTimeline = ({ volume, mediaVolume, src, mediaType, playbackRate, displayName, stack, showInTimeline, premountDisplay, postmountDisplay, loopDisplay, trimBefore, trimAfter, controls })=>{
    const parentSequence = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].SequenceContext);
    const startsAt = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useMediaStartsAt();
    const { registerSequence, unregisterSequence } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].SequenceManager);
    const [sequenceId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useMediaInTimeline.useState": ()=>String(Math.random())
    }["useMediaInTimeline.useState"]);
    const [mediaId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useMediaInTimeline.useState": ()=>String(Math.random())
    }["useMediaInTimeline.useState"]);
    const frame = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentFrame"])();
    const { volumes, duration, doesVolumeChange, nonce, rootId, isStudio, finalDisplayName } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useBasicMediaInTimeline({
        volume,
        mediaVolume,
        mediaType,
        src,
...
;
var { useUnsafeVideoConfig, Timeline, SharedAudioContext, useMediaMutedState, useMediaVolumeState, useFrameForVolumeProp, evaluateVolume, warnAboutTooHighVolume, usePreload, SequenceContext } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"];
var AudioForPreviewAssertedShowing = ({ src, playbackRate, logLevel, muted, volume, loopVolumeCurveBehavior, loop, trimAfter, trimBefore, name, showInTimeline, stack, disallowFallbackToHtml5Audio, toneFrequency, audioStreamIndex, fallbackHtml5AudioProps, debugAudioScheduling, onError, controls })=>{
    const videoConfig = useUnsafeVideoConfig();
    const frame = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentFrame"])();
    const mediaPlayerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const initialTrimBeforeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(trimBefore);
    const initialTrimAfterRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(trimAfter);
    const [mediaPlayerReady, setMediaPlayerReady] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [shouldFallbackToNativeAudio, setShouldFallbackToNativeAudio] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [playing] = Timeline.usePlayingState();
    const timelineContext = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useTimelineContext();
    ...
    const buffer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBufferState"])();
    const [mediaMuted] = useMediaMutedState();
    const [mediaVolume] = useMediaVolumeState();
    const [mediaDurationInSeconds, setMediaDurationInSeconds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const isPlayerBuffering = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useIsPlayerBuffering(bufferingContext);
    const initialPlaying = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(playing && !isPlayerBuffering);
    const initialIsPremounting = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(isPremounting);
    const initialIsPostmounting = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(isPostmounting);
    const initialGlobalPlaybackRate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(globalPlaybackRate);
    const initialPlaybackRate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(playbackRate);
    const initialMuted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(effectiveMuted);
    const initialSequenceOffset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(sequenceOffset);
    useCommonEffects({
        mediaPlayerRef,
        mediaPlayerReady,
        currentTimeRef,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AudioForPreviewAssertedShowing.useEffect2": ()=>{
            ...
            try {
                ...
                player.initialize(currentTimeRef.current, initialMuted.current).then({
                    "AudioForPreviewAssertedShowing.useEffect2": (result)=>{
                        if (result.type === "disposed") {
                            return;
                        }
                        const handleError = {
                            "AudioForPreviewAssertedShowing.useEffect2.handleError": (error, fallbackMessage)=>{
                                ...
                                if (action === "fail") {
                                    ...
                                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.warn({
                                        logLevel,
                                        tag: "@remotion/media"
                                    }, fallbackMessage);
                        ...
                        }["AudioForPreviewAssertedShowing.useEffect2.handleError"];
                ...
                }["AudioForPreviewAssertedShowing.useEffect2"]).catch({
                    "AudioForPreviewAssertedShowing.useEffect2": (error)=>{
                        const [action, errorToUse] = callOnErrorAndResolve({
                            onError,
                            error,
                            disallowFallback: disallowFallbackToHtml5Audio,
                        ...
                        if (action === "fail") {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.error({
                                logLevel,
                                tag: "@remotion/media"
                            }, "[AudioForPreview] Failed to initialize MediaPlayer", error);
                            setShouldFallbackToNativeAudio(true);
                        }
                    }
                }["AudioForPreviewAssertedShowing.useEffect2"]);
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.error({
                    logLevel,
                    tag: "@remotion/media"
                }, "[AudioForPreview] MediaPlayer initialization failed", errorToUse);
                setShouldFallbackToNativeAudio(true);
            }
            return ({
                "AudioForPreviewAssertedShowing.useEffect2": ()=>{
    ...
    if (shouldFallbackToNativeAudio && !disallowFallbackToHtml5Audio) {
        return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Audio"], {
            src,
            muted,
            volume,
...
var AudioForPreview = ({ loop = false, src, logLevel, muted, name, volume, loopVolumeCurveBehavior, playbackRate = 1, trimAfter, trimBefore, showInTimeline, stack, disallowFallbackToHtml5Audio, toneFrequency, audioStreamIndex, fallbackHtml5AudioProps, debugAudioScheduling, onError, controls })=>{
    const preloadedSrc = usePreload(src);
    const defaultLogLevel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useLogLevel();
    const frame = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentFrame"])();
    const videoConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useVideoConfig"])();
    const currentTime = frame / videoConfig.fps;
    const showShow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AudioForPreview.useMemo2[showShow]": ()=>{
            return getTimeInSeconds({
    ...
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(AudioForPreviewAssertedShowing, {
        audioStreamIndex: audioStreamIndex ?? 0,
        src: preloadedSrc,
        playbackRate,
...
var makeAudioIterator2 = ({ audioSampleSink, isMatroska, startTimestamp, src, actualMatroskaTimestamps, logLevel })=>{
    ...
    const logOpenFrames = ()=>{
        ...
        if (openTimestamps.length > 0) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.verbose({
                logLevel,
                tag: "@remotion/media"
            }, "Open audio samples for src", src, `${first.toFixed(3)}...${last.toFixed(3)}`);
        }
    };
    const getCacheStats = ()=>{
        return {
...
var makeKeyframeBank = async ({ logLevel: parentLogLevel, src, videoSampleSink, initialTimestampRequest })=>{
...
var makeKeyframeManager = ()=>{
    ...
    const deleteOldestKeyframeBank = (logLevel)=>{
        const { mostInThePastBank: { bank: mostInThePastBank, src: mostInThePastSrc, index: mostInThePastIndex }, numberOfBanks } = getTheKeyframeBankMostInThePast();
        if (numberOfBanks < 2) {
            return {
                finish: true
            };
    ...
    const ensureToStayUnderMaxCacheSize = (logLevel, maxCacheSize)=>{
        ...
        while(cacheStats.totalSize > maxCacheSize && attempts < maxAttempts){
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.verbose({
                logLevel,
                tag: "@remotion/media"
            }, "Deleted oldest keyframe bank to stay under max cache size", (cacheStats.totalSize / 1024 / 1024).toFixed(1), "out of", (maxCacheSize / 1024 / 1024).toFixed(1));
    ...
    const clearKeyframeBanksBeforeTime = ({ timestampInSeconds, src, logLevel, fps })=>{
    ...
    const getKeyframeBankOrRefetch = async ({ timestamp, videoSampleSink, src, logLevel })=>{
        ...
        addKeyframeBank({
            src,
            bank: replacementKeybank
        });
        return replacementKeybank;
    };
    const requestKeyframeBank = async ({ timestamp, videoSampleSink, src, logLevel, maxCacheSize, fps })=>{
...
var getUncachedMaxCacheSize = (logLevel)=>{
    if (typeof window !== "undefined" && window.remotion_mediaCacheSizeInBytes !== undefined && window.remotion_mediaCacheSizeInBytes !== null) {
        if (window.remotion_mediaCacheSizeInBytes < 240 * 1024 * 1024) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cancelRender"])(new Error(`The minimum value for the "mediaCacheSizeInBytes" prop is 240MB (${240 * 1024 * 1024}), got: ${window.remotion_mediaCacheSizeInBytes}`));
        }
        if (window.remotion_mediaCacheSizeInBytes > 20000 * 1024 * 1024) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cancelRender"])(new Error(`The maximum value for the "mediaCacheSizeInBytes" prop is 20GB (${20000 * 1024 * 1024}), got: ${window.remotion_mediaCacheSizeInBytes}`));
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.verbose({
            logLevel,
            tag: "@remotion/media"
...
var useMaxMediaCacheSize = (logLevel)=>{
    const context = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useContext(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].MaxMediaCacheSizeContext);
    if (context === null) {
...
var resampleAudioData = ({ srcNumberOfChannels, sourceChannels, destination, targetFrames, chunkSize })=>{
...
// src/looped-frame.ts
var frameForVolumeProp = ({ behavior, loop, assetDurationInSeconds, fps, frame, startsAt })=>{
    if (!loop) {
...
var convertAudioData = ({ audioData, trimStartInSeconds, trimEndInSeconds, playbackRate, audioDataTimestamp, isLast })=>{
    ...
    if (isF32) {
        ...
        for(let ch = 0; ch < srcNumberOfChannels; ch++){
            audioData.copyTo(new Float32Array(f32Buffer, ch * bytesPerPlane, frameCount), {
                planeIndex: ch,
                frameOffset,
                frameCount,
                format: "f32-planar"
...
var getSinks = async (src)=>{
    const input = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$input$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"]({
        formats: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$input$2d$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ALL_FORMATS"],
        source: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$source$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UrlSource"](src, {
            getRetryDelay
        })
    });
    const format = await getFormatOrNullOrNetworkError(input);
    const isMatroska = format === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$input$2d$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MATROSKA"] || format === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$input$2d$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WEBM"];
    const getVideoSinks = async ()=>{
        ...
        const sampleSink = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$media$2d$sink$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VideoSampleSink"](videoTrack);
        const packetSink = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$media$2d$sink$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EncodedPacketSink"](videoTrack);
    ...
    const getAudioSinks = async (index)=>{
        ...
        return {
            sampleSink: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$mediabunny$2f$dist$2f$modules$2f$src$2f$media$2d$sink$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioSampleSink"](audioTrack)
        };
    };
...
var extractAudioInternal = async ({ src, timeInSeconds: unloopedTimeInSeconds, durationInSeconds: durationNotYetApplyingPlaybackRate, logLevel, loop, playbackRate, audioStreamIndex, trimBefore, trimAfter, fps, maxCacheSize })=>{
...
;
var extractFrameInternal = async ({ src, timeInSeconds: unloopedTimeInSeconds, logLevel, loop, trimAfter, trimBefore, playbackRate, fps, maxCacheSize })=>{
    ...
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.info({
            logLevel,
            tag: "@remotion/media"
        }, `Error decoding ${src} at time ${timeInSeconds}: ${err}`, err);
        return {
            type: "cannot-decode",
            durationInSeconds: mediaDurationInSeconds
        };
...
var rotateFrame = async ({ frame, rotation })=>{
    if (rotation === 0) {
...
var extractFrameAndAudio = async ({ src, timeInSeconds, logLevel, durationInSeconds, playbackRate, includeAudio, includeVideo, loop, audioStreamIndex, trimAfter, trimBefore, fps, maxCacheSize })=>{
    try {
...
var extractFrameViaBroadcastChannel = async ({ src, timeInSeconds, logLevel, durationInSeconds, playbackRate, includeAudio, includeVideo, isClientSideRendering, loop, audioStreamIndex, trimAfter, trimBefore, fps, maxCacheSize })=>{
...
;
var AudioForRendering = ({ volume: volumeProp, playbackRate, src, muted, loopVolumeCurveBehavior, delayRenderRetries, delayRenderTimeoutInMilliseconds, logLevel: overriddenLogLevel, loop, fallbackHtml5AudioProps, audioStreamIndex, showInTimeline, style, name, disallowFallbackToHtml5Audio, toneFrequency, trimAfter, trimBefore, onError })=>{
    const defaultLogLevel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useLogLevel();
    const logLevel = overriddenLogLevel ?? defaultLogLevel;
    const frame = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentFrame"])();
    const absoluteFrame = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useTimelinePosition();
    const videoConfig = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useUnsafeVideoConfig();
    const { registerRenderAsset, unregisterRenderAsset } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].RenderAssetManager);
    const startsAt = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useMediaStartsAt();
    const environment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRemotionEnvironment"])();
    if (!videoConfig) {
        throw new Error("No video config found");
    }
    if (!src) {
    ...
    const { delayRender, continueRender } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDelayRender"])();
    const [replaceWithHtml5Audio, setReplaceWithHtml5Audio] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const sequenceContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].SequenceContext);
    const id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AudioForRendering.useMemo3[id]": ()=>`media-audio-${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["random"])(src)}-${sequenceContext?.cumulatedFrom}-${sequenceContext?.relativeFrom}-${sequenceContext?.durationInFrames}`
    }["AudioForRendering.useMemo3[id]"], [
        src,
    ...
    const audioEnabled = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useAudioEnabled();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "AudioForRendering.useLayoutEffect2": ()=>{
            const timestamp = frame / fps;
            const durationInSeconds = 1 / fps;
            const shouldRenderAudio = ({
                "AudioForRendering.useLayoutEffect2.shouldRenderAudio": ()=>{
                    if (!audioEnabled) {
                        return false;
                    }
                    if (muted) {
            ...
            extractFrameViaBroadcastChannel({
                ...
                "AudioForRendering.useLayoutEffect2": (result)=>{
                    const handleError = {
                        "AudioForRendering.useLayoutEffect2.handleError": (error, clientSideError, fallbackMessage)=>{
                            const [action, errorToUse] = callOnErrorAndResolve({
                                onError,
                                error,
                            ...
                            if (action === "fail") {
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cancelRender"])(errorToUse);
                            }
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.warn({
                                logLevel,
                                tag: "@remotion/media"
                    ...
                    }["AudioForRendering.useLayoutEffect2.handleError"];
                    if (result.type === "unknown-container-format") {
                    ...
                    const volume = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].evaluateVolume({
                        volume: volumeProp,
                        frame: volumePropsFrame,
                        mediaVolume: 1
                    });
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].warnAboutTooHighVolume(volume);
                    if (audio && volume > 0) {
            ...
            }["AudioForRendering.useLayoutEffect2"]).catch({
                "AudioForRendering.useLayoutEffect2": (error)=>{
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cancelRender"])(error);
                }
            }["AudioForRendering.useLayoutEffect2"]);
            return ({
                "AudioForRendering.useLayoutEffect2": ()=>{
    ...
    if (replaceWithHtml5Audio) {
        return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Html5Audio"], {
            src,
            playbackRate,
            muted,
            loop,
...
;
var { validateMediaProps } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"];
var audioSchema = {
    volume: {
        type: "number",
        min: 0,
...
var Audio = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].wrapInSchema(AudioInner, audioSchema);
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].addSequenceStackTraces(Audio);
;
;
;
;
var { useUnsafeVideoConfig: useUnsafeVideoConfig2, Timeline: Timeline2, SharedAudioContext: SharedAudioContext2, useMediaMutedState: useMediaMutedState2, useMediaVolumeState: useMediaVolumeState2, useFrameForVolumeProp: useFrameForVolumeProp2, evaluateVolume: evaluateVolume2, warnAboutTooHighVolume: warnAboutTooHighVolume2, usePreload: usePreload2, SequenceContext: SequenceContext2, SequenceVisibilityToggleContext } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"];
var VideoForPreviewAssertedShowing = ({ src: unpreloadedSrc, style, playbackRate, logLevel, className, muted, volume, loopVolumeCurveBehavior, onVideoFrame, showInTimeline, loop, name, trimAfter, trimBefore, stack, disallowFallbackToOffthreadVideo, fallbackOffthreadVideoProps, audioStreamIndex, debugOverlay, debugAudioScheduling, headless, onError, controls })=>{
    ...
    const initialTrimBeforeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(trimBefore);
    const initialTrimAfterRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(trimAfter);
    const initialOnVideoFrameRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(onVideoFrame);
    const [mediaPlayerReady, setMediaPlayerReady] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [shouldFallbackToNativeVideo, setShouldFallbackToNativeVideo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [playing] = Timeline2.usePlayingState();
    const timelineContext = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useTimelineContext();
    const globalPlaybackRate = timelineContext.playbackRate;
    const sharedAudioContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(SharedAudioContext2);
    const buffer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBufferState"])();
    ...
    const parentSequence = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(SequenceContext2);
    const isPremounting = Boolean(parentSequence?.premounting);
    const isPostmounting = Boolean(parentSequence?.postmounting);
    const sequenceOffset = ((parentSequence?.cumulatedFrom ?? 0) + (parentSequence?.relativeFrom ?? 0)) / videoConfig.fps;
    const loopDisplay = useLoopDisplay({
    ...
    const buffering = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].BufferingContextReact);
    if (!buffering) {
        throw new Error("useMediaPlayback must be used inside a <BufferingContext>");
    }
    const effectiveMuted = isSequenceHidden || muted || mediaMuted || userPreferredVolume <= 0;
    const isPlayerBuffering = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useIsPlayerBuffering(buffering);
    const initialPlaying = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(playing && !isPlayerBuffering);
    const initialIsPremounting = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(isPremounting);
    const initialIsPostmounting = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(isPostmounting);
    const initialGlobalPlaybackRate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(globalPlaybackRate);
    ...
    const initialSequenceOffset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(sequenceOffset);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VideoForPreviewAssertedShowing.useEffect3": ()=>{
            if (!sharedAudioContext) return;
            if (!sharedAudioContext.audioContext) return;
            const { audioContext, audioSyncAnchor, scheduleAudioNode } = sharedAudioContext;
            try {
                ...
                mediaPlayerRef.current = player;
                player.initialize(currentTimeRef.current, initialMuted.current).then({
                    "VideoForPreviewAssertedShowing.useEffect3": (result)=>{
                        if (result.type === "disposed") {
                            return;
                        }
                        const handleError = {
                            "VideoForPreviewAssertedShowing.useEffect3.handleError": (error, fallbackMessage)=>{
                                const [action, errorToUse] = callOnErrorAndResolve({
                                    onError,
                                    error,
                        ...
                        }["VideoForPreviewAssertedShowing.useEffect3.handleError"];
                        if (result.type === "unknown-container-format") {
                ...
                }["VideoForPreviewAssertedShowing.useEffect3"]).catch({
                    "VideoForPreviewAssertedShowing.useEffect3": (error)=>{
                        const [action, errorToUse] = callOnErrorAndResolve({
                            onError,
                            error,
                            disallowFallback: disallowFallbackToOffthreadVideo,
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.error({
                            logLevel,
                            tag: "@remotion/media"
                        }, "[VideoForPreview] Failed to initialize MediaPlayer", errorToUse);
                        setShouldFallbackToNativeVideo(true);
                    }
                }["VideoForPreviewAssertedShowing.useEffect3"]);
            } catch (error) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].Log.error({
                    logLevel,
                    tag: "@remotion/media"
                }, "[VideoForPreview] MediaPlayer initialization failed", errorToUse);
                setShouldFallbackToNativeVideo(true);
            }
            return ({
                "VideoForPreviewAssertedShowing.useEffect3": ()=>{
    ...
    const classNameValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "VideoForPreviewAssertedShowing.useMemo4[classNameValue]": ()=>{
            return [
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].OBJECTFIT_CONTAIN_CLASS_NAME,
                className
            ].filter(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].truthy).join(" ");
        }
    }["VideoForPreviewAssertedShowing.useMemo4[classNameValue]"], [
        className
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "VideoForPreviewAssertedShowing.useLayoutEffect3": ()=>{
            const mediaPlayer = mediaPlayerRef.current;
            if (!mediaPlayer || !mediaPlayerReady) {
                return;
            }
    ...
    const actualStyle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "VideoForPreviewAssertedShowing.useMemo4[actualStyle]": ()=>{
            return {
                ...style,
    ...
    if (shouldFallbackToNativeVideo && !disallowFallbackToOffthreadVideo) {
        return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Html5Video"], {
            src,
            style: actualStyle,
            className,
            muted,
...
var VideoForPreview = (props)=>{
    ...
    const currentTime = frame / videoConfig.fps;
    const showShow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "VideoForPreview.useMemo4[showShow]": ()=>{
            return getTimeInSeconds({
                unloopedTimeInSeconds: currentTime,
                playbackRate: props.playbackRate,
                loop: props.loop,
    ...
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(VideoForPreviewAssertedShowing, {
        ...props,
...
;
;
var VideoForRendering = ({ volume: volumeProp, playbackRate, src, muted, loopVolumeCurveBehavior, delayRenderRetries, delayRenderTimeoutInMilliseconds, onVideoFrame, logLevel, loop, style, className, fallbackOffthreadVideoProps, audioStreamIndex, name, disallowFallbackToOffthreadVideo, stack, toneFrequency, trimAfterValue, trimBeforeValue, headless, onError })=>{
    if (!src) {
        throw new TypeError("No `src` was passed to <Video>.");
    }
    const frame = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentFrame"])();
    const absoluteFrame = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useTimelinePosition();
    const { fps } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useVideoConfig"])();
    const { registerRenderAsset, unregisterRenderAsset } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].RenderAssetManager);
    const startsAt = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useMediaStartsAt();
    const sequenceContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].SequenceContext);
    const id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "VideoForRendering.useMemo5[id]": ()=>`media-video-${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["random"])(src)}-${sequenceContext?.cumulatedFrom}-${sequenceContext?.relativeFrom}-${sequenceContext?.durationInFrames}`
    }["VideoForRendering.useMemo5[id]"], [
        src,
        sequenceContext?.cumulatedFrom,
        sequenceContext?.relativeFrom,
        sequenceContext?.durationInFrames
    ...
    const environment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRemotionEnvironment"])();
    const { delayRender, continueRender, cancelRender: cancelRender3 } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDelayRender"])();
    const canvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [replaceWithOffthreadVideo, setReplaceWithOffthreadVideo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const audioEnabled = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useAudioEnabled();
    const videoEnabled = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useVideoEnabled();
    const maxCacheSize = useMaxMediaCacheSize(logLevel);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "VideoForRendering.useLayoutEffect4": ()=>{
            ...
            const shouldRenderAudio = ({
                "VideoForRendering.useLayoutEffect4.shouldRenderAudio": ()=>{
                    if (!audioEnabled) {
                        return false;
                    }
                    if (muted) {
            ...
            extractFrameViaBroadcastChannel({
                ...
                "VideoForRendering.useLayoutEffect4": (result)=>{
                    const handleError = {
                        "VideoForRendering.useLayoutEffect4.handleError": (err, clientSideError, fallbackMessage, mediaDurationInSeconds)=>{
                    ...
                    }["VideoForRendering.useLayoutEffect4.handleError"];
                    if (result.type === "unknown-container-format") {
            ...
            }["VideoForRendering.useLayoutEffect4"]).catch({
                "VideoForRendering.useLayoutEffect4": (err)=>{
                    cancelRender3(err);
                }
            }["VideoForRendering.useLayoutEffect4"]);
            return ({
    ...
    const classNameValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "VideoForRendering.useMemo5[classNameValue]": ()=>{
            return [
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].OBJECTFIT_CONTAIN_CLASS_NAME,
                className
            ].filter(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].truthy).join(" ");
    ...
    if (replaceWithOffthreadVideo) {
        const fallback = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].InnerOffthreadVideo, {
            src,
            playbackRate: playbackRate ?? 1,
            muted: muted ?? false,
        ...
        if (loop) {
            ...
            return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Loop"], {
                layout: "none",
                durationInFrames: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].calculateMediaDuration({
                    trimAfter: trimAfterValue,
...
;
var { validateMediaTrimProps, resolveTrimProps, validateMediaProps: validateMediaProps2 } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"];
var videoSchema = {
    volume: {
        type: "number",
        min: 0,
...
var VideoInner = ({ src, audioStreamIndex, className, delayRenderRetries, delayRenderTimeoutInMilliseconds, disallowFallbackToOffthreadVideo, fallbackOffthreadVideoProps, logLevel, loop, loopVolumeCurveBehavior, muted, name, onVideoFrame, playbackRate, showInTimeline, style, trimAfter, trimBefore, volume, stack, toneFrequency, debugOverlay, debugAudioScheduling, headless, onError, controls })=>{
    const fallbackLogLevel = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].useLogLevel();
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(InnerVideo, {
        audioStreamIndex: audioStreamIndex ?? 0,
        className,
        delayRenderRetries: delayRenderRetries ?? null,
        delayRenderTimeoutInMilliseconds: delayRenderTimeoutInMilliseconds ?? null,
...
var Video = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].wrapInSchema(VideoInner, videoSchema);
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$remotion$2f$media$2f$node_modules$2f$remotion$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Internals"].addSequenceStackTraces(Video);
// src/index.ts
...
//# sourceMappingURL=node_modules_%40remotion_media_dist_esm_index_mjs_4bde0079._.js.map